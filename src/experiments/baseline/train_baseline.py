...
def main():
    ...
    trainer = BaselineTrainer(
        ...
        model_dir="models/baseline",  # Aligné avec résultats Colab
        batch_size=32,
        num_epochs=50,
        learning_rate=0.001,
        weight_decay=1e-4
    ...
    print("="*60)
    print("Ces hyperparamètres sont identiques à l'entraînement Colab:")
    print("  - Batch size: 32")
    print("  - Max epochs: 50 (avec early stopping)")
